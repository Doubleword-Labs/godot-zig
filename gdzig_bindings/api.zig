...
pub const ClassGetVirtual = fn (?*anyopaque, c.GDExtensionConstStringNamePtr) callconv(.c) ?*const ClassCallVirtual;
pub const ClassGetVirtual2 = fn (?*anyopaque, c.GDExtensionConstStringNamePtr, u32) callconv(.c) ?*const ClassCallVirtual;
...
pub const ScriptInstanceGetPropertyState = fn (c.GDExtensionScriptInstanceDataPtr, ?*const ScriptInstancePropertyStateAdd, ?*anyopaque) callconv(.c) void;
...
pub const InterfaceGetProcAddress = fn ([*c]const u8) callconv(.c) ?*const InterfaceFunctionPtr;
pub const InitializationFunction = fn (?*const InterfaceGetProcAddress, c.GDExtensionClassLibraryPtr, [*c]c.GDExtensionInitialization) callconv(.c) c.GDExtensionBool;
