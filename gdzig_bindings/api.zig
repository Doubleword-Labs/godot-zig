...
pub const VariantFromTypeConstructorFunc = fn (c.GDExtensionUninitializedVariantPtr, c.GDExtensionTypePtr) callconv(.c) void;
pub const TypeFromVariantConstructorFunc = fn (c.GDExtensionUninitializedTypePtr, c.GDExtensionVariantPtr) callconv(.c) void;
pub const VariantGetInternalPtrFunc = fn (c.GDExtensionVariantPtr) callconv(.c) ?*anyopaque;
pub const PtrOperatorEvaluator = fn (c.GDExtensionConstTypePtr, c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;
pub const PtrBuiltInMethod = fn (c.GDExtensionTypePtr, [*c]const c.GDExtensionConstTypePtr, c.GDExtensionTypePtr, c_int) callconv(.c) void;
pub const PtrConstructor = fn (c.GDExtensionUninitializedTypePtr, [*c]const c.GDExtensionConstTypePtr) callconv(.c) void;
pub const PtrDestructor = fn (c.GDExtensionTypePtr) callconv(.c) void;
pub const PtrSetter = fn (c.GDExtensionTypePtr, c.GDExtensionConstTypePtr) callconv(.c) void;
pub const PtrGetter = fn (c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;
pub const PtrIndexedSetter = fn (c.GDExtensionTypePtr, c.GDExtensionInt, c.GDExtensionConstTypePtr) callconv(.c) void;
pub const PtrIndexedGetter = fn (c.GDExtensionConstTypePtr, c.GDExtensionInt, c.GDExtensionTypePtr) callconv(.c) void;
pub const PtrKeyedSetter = fn (c.GDExtensionTypePtr, c.GDExtensionConstTypePtr, c.GDExtensionConstTypePtr) callconv(.c) void;
pub const PtrKeyedGetter = fn (c.GDExtensionConstTypePtr, c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;
pub const PtrKeyedChecker = fn (c.GDExtensionConstVariantPtr, c.GDExtensionConstVariantPtr) callconv(.c) u32;
pub const PtrUtilityFunction = fn (c.GDExtensionTypePtr, [*c]const c.GDExtensionConstTypePtr, c_int) callconv(.c) void;

pub const ClassConstructor = fn (...) callconv(.c) c.GDExtensionObjectPtr;

pub const InstanceBindingCreateCallback = fn (?*anyopaque, ?*anyopaque) callconv(.c) ?*anyopaque;
pub const InstanceBindingFreeCallback = fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void;
pub const InstanceBindingReferenceCallback = fn (?*anyopaque, ?*anyopaque, c.GDExtensionBool) callconv(.c) c.GDExtensionBool;

pub const ClassSet = fn (c.GDExtensionClassInstancePtr, c.GDExtensionConstStringNamePtr, c.GDExtensionConstVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ClassGet = fn (c.GDExtensionClassInstancePtr, c.GDExtensionConstStringNamePtr, c.GDExtensionVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ClassGetRID = fn (c.GDExtensionClassInstancePtr) callconv(.c) u64;
pub const ClassGetPropertyList = fn (c.GDExtensionClassInstancePtr, [*c]u32) callconv(.c) [*c]const c.GDExtensionPropertyInfo;
pub const ClassFreePropertyList = fn (c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionPropertyInfo) callconv(.c) void;
pub const ClassFreePropertyList2 = fn (c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionPropertyInfo, u32) callconv(.c) void;
pub const ClassPropertyCanRevert = fn (c.GDExtensionClassInstancePtr, c.GDExtensionConstStringNamePtr) callconv(.c) c.GDExtensionBool;
pub const ClassPropertyGetRevert = fn (c.GDExtensionClassInstancePtr, c.GDExtensionConstStringNamePtr, c.GDExtensionVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ClassValidateProperty = fn (c.GDExtensionClassInstancePtr, [*c]c.GDExtensionPropertyInfo) callconv(.c) c.GDExtensionBool;
pub const ClassNotification = fn (c.GDExtensionClassInstancePtr, i32) callconv(.c) void;
pub const ClassNotification2 = fn (c.GDExtensionClassInstancePtr, i32, c.GDExtensionBool) callconv(.c) void;
pub const ClassToString = fn (c.GDExtensionClassInstancePtr, [*c]c.GDExtensionBool, c.GDExtensionStringPtr) callconv(.c) void;
pub const ClassReference = fn (c.GDExtensionClassInstancePtr) callconv(.c) void;
pub const ClassUnreference = fn (c.GDExtensionClassInstancePtr) callconv(.c) void;
pub const ClassCallVirtual = fn (c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;
pub const ClassCreateInstance = fn (?*anyopaque) callconv(.c) c.GDExtensionObjectPtr;
pub const ClassCreateInstance2 = fn (?*anyopaque, c.GDExtensionBool) callconv(.c) c.GDExtensionObjectPtr;
pub const ClassFreeInstance = fn (?*anyopaque, c.GDExtensionClassInstancePtr) callconv(.c) void;
pub const ClassRecreateInstance = fn (?*anyopaque, c.GDExtensionObjectPtr) callconv(.c) c.GDExtensionClassInstancePtr;
pub const ClassGetVirtual = fn (?*anyopaque, c.GDExtensionConstStringNamePtr) callconv(.c) c.GDExtensionClassCallVirtual;
pub const ClassGetVirtual2 = fn (?*anyopaque, c.GDExtensionConstStringNamePtr, u32) callconv(.c) c.GDExtensionClassCallVirtual;
pub const ClassGetVirtualCallData = fn (?*anyopaque, c.GDExtensionConstStringNamePtr) callconv(.c) ?*anyopaque;
pub const ClassGetVirtualCallData2 = fn (?*anyopaque, c.GDExtensionConstStringNamePtr, u32) callconv(.c) ?*anyopaque;
pub const ClassCallVirtualWithData = fn (c.GDExtensionClassInstancePtr, c.GDExtensionConstStringNamePtr, ?*anyopaque, [*c]const c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;

pub const ClassMethodCall = fn (?*anyopaque, c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionConstVariantPtr, c.GDExtensionInt, c.GDExtensionVariantPtr, [*c]c.GDExtensionCallError) callconv(.c) void;
pub const ClassMethodValidatedCall = fn (?*anyopaque, c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionConstVariantPtr, c.GDExtensionVariantPtr) callconv(.c) void;
pub const ClassMethodPtrCall = fn (?*anyopaque, c.GDExtensionClassInstancePtr, [*c]const c.GDExtensionConstTypePtr, c.GDExtensionTypePtr) callconv(.c) void;

pub const CallableCustomCall = fn (?*anyopaque, [*c]const c.GDExtensionConstVariantPtr, c.GDExtensionInt, c.GDExtensionVariantPtr, [*c]c.GDExtensionCallError) callconv(.c) void;
pub const CallableCustomIsValid = fn (?*anyopaque) callconv(.c) c.GDExtensionBool;
pub const CallableCustomFree = fn (?*anyopaque) callconv(.c) void;
pub const CallableCustomHash = fn (?*anyopaque) callconv(.c) u32;
pub const CallableCustomEqual = fn (?*anyopaque, ?*anyopaque) callconv(.c) c.GDExtensionBool;
pub const CallableCustomLessThan = fn (?*anyopaque, ?*anyopaque) callconv(.c) c.GDExtensionBool;
pub const CallableCustomToString = fn (?*anyopaque, [*c]c.GDExtensionBool, c.GDExtensionStringPtr) callconv(.c) void;
pub const CallableCustomGetArgumentCount = fn (?*anyopaque, [*c]c.GDExtensionBool) callconv(.c) c.GDExtensionInt;

pub const ScriptInstanceSet = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, c.GDExtensionConstVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGet = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, c.GDExtensionVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetPropertyList = fn (c.GDExtensionScriptInstanceDataPtr, [*c]u32) callconv(.c) [*c]const c.GDExtensionPropertyInfo;
pub const ScriptInstanceFreePropertyList = fn (c.GDExtensionScriptInstanceDataPtr, [*c]const c.GDExtensionPropertyInfo) callconv(.c) void;
pub const ScriptInstanceFreePropertyList2 = fn (c.GDExtensionScriptInstanceDataPtr, [*c]const c.GDExtensionPropertyInfo, u32) callconv(.c) void;
pub const ScriptInstanceGetClassCategory = fn (c.GDExtensionScriptInstanceDataPtr, [*c]c.GDExtensionPropertyInfo) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetPropertyType = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, [*c]c.GDExtensionBool) callconv(.c) c.GDExtensionVariantType;
pub const ScriptInstanceValidateProperty = fn (c.GDExtensionScriptInstanceDataPtr, [*c]c.GDExtensionPropertyInfo) callconv(.c) c.GDExtensionBool;
pub const ScriptInstancePropertyCanRevert = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstancePropertyGetRevert = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, c.GDExtensionVariantPtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetOwner = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) c.GDExtensionObjectPtr;
pub const ScriptInstancePropertyStateAdd = fn (c.GDExtensionConstStringNamePtr, c.GDExtensionConstVariantPtr, ?*anyopaque) callconv(.c) void;
pub const ScriptInstanceGetPropertyState = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionScriptInstancePropertyStateAdd, ?*anyopaque) callconv(.c) void;
pub const ScriptInstanceGetMethodList = fn (c.GDExtensionScriptInstanceDataPtr, [*c]u32) callconv(.c) [*c]const c.GDExtensionMethodInfo;
pub const ScriptInstanceFreeMethodList = fn (c.GDExtensionScriptInstanceDataPtr, [*c]const c.GDExtensionMethodInfo) callconv(.c) void;
pub const ScriptInstanceFreeMethodList2 = fn (c.GDExtensionScriptInstanceDataPtr, [*c]const c.GDExtensionMethodInfo, u32) callconv(.c) void;
pub const ScriptInstanceHasMethod = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetMethodArgumentCount = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, [*c]c.GDExtensionBool) callconv(.c) c.GDExtensionInt;
pub const ScriptInstanceCall = fn (c.GDExtensionScriptInstanceDataPtr, c.GDExtensionConstStringNamePtr, [*c]const c.GDExtensionConstVariantPtr, c.GDExtensionInt, c.GDExtensionVariantPtr, [*c]c.GDExtensionCallError) callconv(.c) void;
pub const ScriptInstanceNotification = fn (c.GDExtensionScriptInstanceDataPtr, i32) callconv(.c) void;
pub const ScriptInstanceNotification2 = fn (c.GDExtensionScriptInstanceDataPtr, i32, c.GDExtensionBool) callconv(.c) void;
pub const ScriptInstanceToString = fn (c.GDExtensionScriptInstanceDataPtr, [*c]c.GDExtensionBool, c.GDExtensionStringPtr) callconv(.c) void;
pub const ScriptInstanceRefCountIncremented = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) void;
pub const ScriptInstanceRefCountDecremented = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetScript = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) c.GDExtensionObjectPtr;
pub const ScriptInstanceIsPlaceholder = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) c.GDExtensionBool;
pub const ScriptInstanceGetLanguage = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) c.GDExtensionScriptLanguagePtr;
pub const ScriptInstanceFree = fn (c.GDExtensionScriptInstanceDataPtr) callconv(.c) void;

pub const InterfaceFunctionPtr = fn (...) callconv(.c) void;
pub const InterfaceGetProcAddress = fn ([*c]const u8) callconv(.c) c.GDExtensionInterfaceFunctionPtr;
pub const InitializationFunction = fn (c.GDExtensionInterfaceGetProcAddress, c.GDExtensionClassLibraryPtr, [*c]c.GDExtensionInitialization) callconv(.c) c.GDExtensionBool;
